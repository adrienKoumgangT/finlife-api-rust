...
pub trait AccountRepositoryInterface {
    ...
    async fn get(&self, account_id: Uuid, user_id: Uuid) -> Result<Option<Account>, Error>;

    async fn create(&self, account: Account, user_id: Uuid) -> Result<Account, Error>;

    async fn update(&self, account_id: Uuid, name: String, account_type: AccountType, institution: Option<String>, user_id: Uuid) -> Result<Option<Account>, Error>;

    async fn archived(&self, account_id: Uuid, archived: bool, user_id: Uuid) -> Result<Option<Account>, Error>;

    async fn delete(&self, account_id: Uuid, user_id: Uuid) -> Result<(), Error>;

    async fn get_by_user(&self, user_id: Uuid) -> Result<Vec<Account>, Error>;
